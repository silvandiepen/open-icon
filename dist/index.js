...
__export(lib_exports, {
  AccessibilityPerson: () => accessibility_person_default,
  AccessibilityPersonCircled: () => accessibility_person_circled_default,
  AddFat: () => add_fat_default,
  AddL: () => add_l_default,
  AddLines: () => add_lines_default,
  AddM: () => add_m_default,
  AddS: () => add_s_default,
  Airplane: () => airplane_default,
  AirplaneArrivals: () => airplane_arrivals_default,
  AirplaneDepartures: () => airplane_departures_default,
  AirportConnectFlights: () => airport_connect_flights_default,
  AirportTransfer: () => airport_transfer_default,
  AirportTransfer2: () => airport_transfer2_default,
  ...
  BicycleSurfboard: () => bicycle_surfboard_default,
  ...
  Box: () => box_default,
  BoxIn: () => box_in_default,
  BoxOut: () => box_out_default,
  Boy: () => boy_default,
  BreadSlice: () => bread_slice_default,
  BriefcaseCross: () => briefcase_cross_default,
  BrokenHeartF: () => broken_heart_f_default,
  BrokenHeartL: () => broken_heart_l_default,
  BrokenHeartM: () => broken_heart_m_default,
  BuildingChurch: () => building_church_default,
  BuildingHouse: () => building_house_default,
  BuildingHouse2: () => building_house2_default,
  BuildingShop: () => building_shop_default,
  Bulb: () => bulb_default,
  Button: () => button_default,
  ButtonAdd: () => button_add_default,
  ButtonBrokenHeart: () => button_broken_heart_default,
  ButtonBrokenHeart2: () => button_broken_heart2_default,
  ButtonCheck: () => button_check_default,
  ButtonCheck2: () => button_check2_default,
  ButtonEdit: () => button_edit_default,
  ButtonEdit2: () => button_edit2_default,
  ButtonExclamationMark: () => button_exclamation_mark_default,
  ButtonExclamationMark2: () => button_exclamation_mark2_default,
  ButtonHeart: () => button_heart_default,
  ButtonHeart2: () => button_heart2_default,
  ButtonInfo: () => button_info_default,
  ButtonInfo2: () => button_info2_default,
  ButtonInvisible: () => button_invisible_default,
  ButtonInvisible2: () => button_invisible2_default,
  ButtonMultiply: () => button_multiply_default,
  ButtonQuestionMark: () => button_question_mark_default,
  ButtonQuestionMark2: () => button_question_mark2_default,
  ButtonSearch: () => button_search_default,
  ButtonSearch2: () => button_search2_default,
  ButtonStar: () => button_star_default,
  ButtonStar2: () => button_star2_default,
  ButtonSubtract: () => button_subtract_default,
  ButtonVisible: () => button_visible_default,
  ButtonVisible2: () => button_visible2_default,
  ...
  Chip: () => chip_default,
  CircleInvisible: () => circle_invisible_default,
  CircleSubtract: () => circle_subtract_default,
  Circled: () => circled_default,
  CircledAdd: () => circled_add_default,
  CircledBrokenHeart: () => circled_broken_heart_default,
  CircledCheck: () => circled_check_default,
  CircledEdit: () => circled_edit_default,
  CircledExclamationMark: () => circled_exclamation_mark_default,
  CircledHeart: () => circled_heart_default,
  CircledInfo: () => circled_info_default,
  CircledMultiply: () => circled_multiply_default,
  CircledQuestionMark: () => circled_question_mark_default,
  CircledSearch: () => circled_search_default,
  CircledStar: () => circled_star_default,
  CircledVisible: () => circled_visible_default,
  ...
  CodeBrackets: () => code_brackets_default,
  CodeBracketsCircled: () => code_brackets_circled_default,
  CodeChevrons: () => code_chevrons_default,
  CodeChevronsCircled: () => code_chevrons_circled_default,
  CodeChevronsOpen: () => code_chevrons_open_default,
  CodeChevronsOpenCircled: () => code_chevrons_open_circled_default,
  ...
  ColorRgb: () => color_rgb_default,
  ColorSwatches: () => color_swatches_default,
  ...
  Euro: () => euro_default,
  ExclamationMarkFat: () => exclamation_mark_fat_default,
  ExclamationMarkL: () => exclamation_mark_l_default,
  ExclamationMarkM: () => exclamation_mark_m_default,
  ExclamationMarkS: () => exclamation_mark_s_default,
  Factory: () => factory_default,
  FactoryArm: () => factory_arm_default,
  FactoryBelt: () => factory_belt_default,
  FemaleSimplified: () => female_simplified_default,
  Ferry: () => ferry_default,
  File: () => file_default,
  FileAdd: () => file_add_default,
  FileAdd267: () => file_add267_default,
  FileAdd269: () => file_add269_default,
  FileArrowUp: () => file_arrow_up_default,
  FileBinary: () => file_binary_default,
  FileBrokenHeart: () => file_broken_heart_default,
  FileBrokenHeart2: () => file_broken_heart2_default,
  FileCheck: () => file_check_default,
  FileCheck2: () => file_check2_default,
  FileCloud: () => file_cloud_default,
  FileCode: () => file_code_default,
  FileColumns: () => file_columns_default,
  FileEdit: () => file_edit_default,
  FileEdit2: () => file_edit2_default,
  FileExclamationMark: () => file_exclamation_mark_default,
  FileExclamationMark2: () => file_exclamation_mark2_default,
  FileGraphs: () => file_graphs_default,
  FileHeart: () => file_heart_default,
  FileHeart2: () => file_heart2_default,
  FileInfo: () => file_info_default,
  FileInfo2: () => file_info2_default,
  FileInvisible: () => file_invisible_default,
  FileInvisible2: () => file_invisible2_default,
  FileMultiply: () => file_multiply_default,
  FileQuestionMark: () => file_question_mark_default,
  FileQuestionMark2: () => file_question_mark2_default,
  FileSearch: () => file_search_default,
  FileSearch2: () => file_search2_default,
  FileStar: () => file_star_default,
  FileStar2: () => file_star2_default,
  FileSubtract: () => file_subtract_default,
  FileSubtract2: () => file_subtract2_default,
  FileText: () => file_text_default,
  FileVisible: () => file_visible_default,
  FileVisible2: () => file_visible2_default,
  Filmroll: () => filmroll_default,
  ...
  FolderBrokenHeart: () => folder_broken_heart_default,
  FolderBrokenHeart2: () => folder_broken_heart2_default,
  ...
  FolderExclamationMark: () => folder_exclamation_mark_default,
  FolderExclamationMark2: () => folder_exclamation_mark2_default,
  FolderHeart: () => folder_heart_default,
  FolderHeart2: () => folder_heart2_default,
  FolderInfo: () => folder_info_default,
  FolderInfo2: () => folder_info2_default,
  FolderInvisible: () => folder_invisible_default,
  FolderInvisible2: () => folder_invisible2_default,
  FolderMultiply: () => folder_multiply_default,
  FolderMultiply2: () => folder_multiply2_default,
  FolderQuestionMark: () => folder_question_mark_default,
  FolderQuestionMark2: () => folder_question_mark2_default,
  FolderSearch: () => folder_search_default,
  FolderSearch2: () => folder_search2_default,
  FolderStar: () => folder_star_default,
  FolderStar2: () => folder_star2_default,
  FolderSubtract: () => folder_subtract_default,
  FolderSubtract2: () => folder_subtract2_default,
  FolderVisible: () => folder_visible_default,
  FolderVisible2: () => folder_visible2_default,
  ...
  GitMergeQueue: () => git_merge_queue_default,
  ...
  GitRepoFork: () => git_repo_fork_default,
  GraphUp: () => graph_up_default,
  GraphUpRound: () => graph_up_round_default,
  Gravestone: () => gravestone_default,
  Gravestone2: () => gravestone2_default,
  Gravestone3: () => gravestone3_default,
  Hairdryer: () => hairdryer_default,
  Hamburger: () => hamburger_default,
  HeartBrokenSmall: () => heart_broken_small_default,
  HeartFat: () => heart_fat_default,
  HeartL: () => heart_l_default,
  HeartM: () => heart_m_default,
  HeartSmall: () => heart_small_default,
  ...
  InfoFat: () => info_fat_default,
  InfoL: () => info_l_default,
  InfoM: () => info_m_default,
  InfoS: () => info_s_default,
  InvisibleFat: () => invisible_fat_default,
  InvisibleL: () => invisible_l_default,
  InvisibleM: () => invisible_m_default,
  InvisibleS: () => invisible_s_default,
  Iron: () => iron_default,
  ...
  MaleSimplified: () => male_simplified_default,
  Metro: () => metro_default,
  ...
  NoteAdd2: () => note_add2_default,
  NoteBrokenHeart: () => note_broken_heart_default,
  NoteBrokenHeart2: () => note_broken_heart2_default,
  NoteCheck: () => note_check_default,
  NoteCheck2: () => note_check2_default,
  NoteEdit: () => note_edit_default,
  NoteEdit2: () => note_edit2_default,
  NoteExclamationMark: () => note_exclamation_mark_default,
  NoteExclamationMark2: () => note_exclamation_mark2_default,
  NoteHeart: () => note_heart_default,
  NoteHeart2: () => note_heart2_default,
  NoteInfo: () => note_info_default,
  NoteInfo2: () => note_info2_default,
  NoteInvisible: () => note_invisible_default,
  NoteInvisible2: () => note_invisible2_default,
  NoteMultiply: () => note_multiply_default,
  NoteMultiply2: () => note_multiply2_default,
  NoteQuestionMark: () => note_question_mark_default,
  NoteQuestionMark2: () => note_question_mark2_default,
  NoteSearch: () => note_search_default,
  NoteSearch2: () => note_search2_default,
  NoteStar: () => note_star_default,
  NoteStar2: () => note_star2_default,
  NoteSubtract: () => note_subtract_default,
  NoteSubtract2: () => note_subtract2_default,
  NoteVisible: () => note_visible_default,
  NoteVisible2: () => note_visible2_default,
  OnTarget: () => on_target_default,
  Oven: () => oven_default,
  ...
  PlaybackBackward: () => playback_backward_default,
  PlaybackEnd: () => playback_end_default,
  PlaybackForward: () => playback_forward_default,
  PlaybackNext: () => playback_next_default,
  PlaybackPause: () => playback_pause_default,
  PlaybackPlay: () => playback_play_default,
  PlaybackPrevious: () => playback_previous_default,
  PlaybackStart: () => playback_start_default,
  PlaybackStop: () => playback_stop_default,
  Politician: () => politician_default,
  Politician2: () => politician2_default,
  Printer: () => printer_default,
  Promille: () => promille_default,
  QuestionMarkFat: () => question_mark_fat_default,
  QuestionMarkL: () => question_mark_l_default,
  QuestionMarkM: () => question_mark_m_default,
  QuestionMarkS: () => question_mark_s_default,
  Reels: () => reels_default,
  RemoveLines: () => remove_lines_default,
  RentalCar: () => rental_car_default,
  RoomShade: () => room_shade_default,
  SearchFat: () => search_fat_default,
  SearchL: () => search_l_default,
  SearchM: () => search_m_default,
  SearchSmall: () => search_small_default,
  ...
  Settings2: () => settings2_default,
  Settings3: () => settings3_default,
  Settings4: () => settings4_default,
  Ship: () => ship_default,
  ...
  SpeechBalloonSquareCopy: () => speech_balloon_square_copy_default,
  SpeechBalloons: () => speech_balloons_default,
  Squared: () => squared_default,
  SquaredAdd: () => squared_add_default,
  SquaredBrokenHeart: () => squared_broken_heart_default,
  SquaredCheck: () => squared_check_default,
  SquaredEdit: () => squared_edit_default,
  SquaredExclamationMark: () => squared_exclamation_mark_default,
  SquaredHeart: () => squared_heart_default,
  SquaredInfo: () => squared_info_default,
  SquaredInvisible: () => squared_invisible_default,
  SquaredMultiply: () => squared_multiply_default,
  SquaredQuestionMark: () => squared_question_mark_default,
  SquaredSearch: () => squared_search_default,
  SquaredStar: () => squared_star_default,
  SquaredSubtract: () => squared_subtract_default,
  SquaredVisible: () => squared_visible_default,
  Stairs: () => stairs_default,
  StairsDown: () => stairs_down_default,
  StairsUp: () => stairs_up_default,
  StarFat: () => star_fat_default,
  StarL: () => star_l_default,
  StarM: () => star_m_default,
  StarSmall: () => star_small_default,
  Stove: () => stove_default,
  ...
  Sun: () => sun_default,
  Sun2: () => sun2_default,
  SymbolFemale: () => symbol_female_default,
  SymbolMale: () => symbol_male_default,
  SymbolUnisex: () => symbol_unisex_default,
  Tables: () => tables_default,
  Tablet: () => tablet_default,
  TabletLandscape: () => tablet_landscape_default,
  Talk: () => talk_default,
  TalkAdd: () => talk_add_default,
  TalkCheck: () => talk_check_default,
  TalkDelete: () => talk_delete_default,
  TalkEdit: () => talk_edit_default,
  TalkExclamationMark: () => talk_exclamation_mark_default,
  TalkHeart: () => talk_heart_default,
  TalkHeartBroken: () => talk_heart_broken_default,
  TalkInfo: () => talk_info_default,
  TalkInvisible: () => talk_invisible_default,
  TalkQuestionMark: () => talk_question_mark_default,
  TalkSearch: () => talk_search_default,
  TalkStar: () => talk_star_default,
  TalkSubtract: () => talk_subtract_default,
  TalkVisible: () => talk_visible_default,
  ...
  TextDetailList: () => text_detail_list_default,
  TextIndent: () => text_indent_default,
  TextItalic: () => text_italic_default,
  TextLineThrough: () => text_line_through_default,
  TextOrderAsc123: () => text_order_asc123_default,
  TextOrderAsc127: () => text_order_asc127_default,
  TextOrderDesc: () => text_order_desc_default,
  TextOrderDescCopy: () => text_order_desc_copy_default,
  TextOrderDescCopy2: () => text_order_desc_copy2_default,
  TextOrderDescCopy3: () => text_order_desc_copy3_default,
  ...
  Triangled: () => triangled_default,
  TriangledExclamationMark: () => triangled_exclamation_mark_default,
  TriangledInfo: () => triangled_info_default,
  TriangledQuestionMark: () => triangled_question_mark_default,
  ...
  UserDelete: () => user_delete_default,
  UserGroup: () => user_group_default,
  Users: () => users_default,
  VideoCamera: () => video_camera_default,
  Videos: () => videos_default,
  VisibleFat: () => visible_fat_default,
  VisibleL: () => visible_l_default,
  VisibleM: () => visible_m_default,
  VisibleS: () => visible_s_default,
  VolumeI: () => volume_i_default,
  VolumeIi: () => volume_ii_default,
  VolumeIii: () => volume_iii_default,
  ...
  Wheelchair: () => wheelchair_default,
  WheelchairAction: () => wheelchair_action_default,
...
// lib/chevron-down.ts
var IconChevronDown = `<svg id="ChevronDown" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><polyline points="13.95 27.23 36.23 49.5 58.5 27.23" style="fill: none;  stroke-linejoin: round; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
var chevron_down_default = IconChevronDown;

// lib/chevron-left.ts
var IconChevronLeft = `<svg id="ChevronLeft" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><polyline points="44.77 13.73 22.5 36 44.77 58.27" style="fill: none;  stroke-linejoin: round; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
var chevron_left_default = IconChevronLeft;

// lib/chevron-right.ts
var IconChevronRight = `<svg id="ChevronRight" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><polyline points="27.23 58.5 49.5 36.23 27.23 13.95" style="fill: none;  stroke-linejoin: round; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
var chevron_right_default = IconChevronRight;

// lib/chevron-up.ts
var IconChevronUp = `<svg id="ChevronUp" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><polyline points="58.5 45 36.23 22.73 13.95 45" style="fill: none;  stroke-linejoin: round; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
...
var IconTwoDotsVertical = `<svg id="TwoDotsVertical" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><circle cx="36" cy="46.12" r="6.75" style="fill: var(--icon-line-color, currentColor); stroke-width: 0px;"/><circle cx="36" cy="25.88" r="6.75" style="fill: var(--icon-line-color, currentColor); stroke-width: 0px;"/></svg>`;
...
var IconNoteVisible2 = `<svg id="NoteVisible2" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><g ><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1);" /></g><g><path d="M58.5,41.5v-24c0-2.21-1.79-4-4-4H17.5c-2.21,0-4,1.79-4,4v37c0,2.21,1.79,4,4,4h18.5" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M58.5,41.5v-24c0-2.21-1.79-4-4-4H17.5c-2.21,0-4,1.79-4,4v37c0,2.21,1.79,4,4,4h18.5" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></g><line x1="22.5" y1="6.5" x2="22.5" y2="20" style="fill: var(--icon-line-color, currentColor); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="31.5" y1="6.5" x2="31.5" y2="20" style="fill: var(--icon-line-color, currentColor); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="40.5" y1="6.5" x2="40.5" y2="20" style="fill: var(--icon-line-color, currentColor); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="49.5" y1="6.5" x2="49.5" y2="20" style="fill: var(--icon-line-color, currentColor); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M67.5,54s-6.04,9-13.5,9-13.5-9-13.5-9c0,0,6.04-9,13.5-9s13.5,9,13.5,9Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><circle cx="54" cy="54" r="4.5" style="stroke-width: 0px;"/></svg>`;
var note_visible2_default = IconNoteVisible2;

// lib/note-visible.ts
var IconNoteVisible = `<svg id="NoteVisible" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><g ><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1);" /></g><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: none;  stroke-linecap: round; stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="22.5" y1="6.5" x2="22.5" y2="20" style="fill: var(--icon-line-color, currentColor); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="31.5" y1="6.5" x2="31.5" y2="20" style="fill: var(--icon-line-color, currentColor); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="40.5" y1="6.5" x2="40.5" y2="20" style="fill: var(--icon-line-color, currentColor); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="49.5" y1="6.5" x2="49.5" y2="20" style="fill: var(--icon-line-color, currentColor); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M49.5,40.5s-6.04,9-13.5,9-13.5-9-13.5-9c0,0,6.04-9,13.5-9s13.5,9,13.5,9Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><circle cx="36" cy="40.5" r="4.5" style="stroke-width: 0px;"/></svg>`;
var note_visible_default = IconNoteVisible;
...
var IconQuestionMarkS = `<svg id="QuestionMarkS" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><line x1="36" y1="49.5" x2="36" y2="49.5" style="fill: none;  stroke-linecap: round; stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M30,33c0-3.31,2.69-6,6-6s6,2.69,6,6c0,6-6,6-6,12" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
var question_mark_s_default = IconQuestionMarkS;
...
var IconSquaredBrokenHeart = `<svg id="SquaredBrokenHeart" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: none; stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><polyline points="36 31.5 38.25 38.25 33.75 40.5 36 49.5" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M36,49.5c-23.38-12.24-11.69-30.85,0-18.36,11.69-12.48,23.38,6.12,0,18.36Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
var squared_broken_heart_default = IconSquaredBrokenHeart;
...
// lib/squared-info.ts
var IconSquaredInfo = `<svg id="SquaredInfo" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: none; stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><g><polyline points="36 49.5 36 36 31.5 36" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="36" y1="27" x2="36" y2="27" style="fill: none;  stroke-linecap: round; stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></g></svg>`;
var squared_info_default = IconSquaredInfo;

// lib/squared-invisible.ts
var IconSquaredInvisible = `<svg id="SquaredInvisible" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: none; stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M49.5,36s-6.04,9-13.5,9-13.5-9-13.5-9c0,0,6.04-9,13.5-9s13.5,9,13.5,9Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="49.5" y1="27" x2="22.5" y2="45" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
var squared_invisible_default = IconSquaredInvisible;
...
var squared_search_default = IconSquaredSearch;

// lib/squared-star.ts
var IconSquaredStar = `<svg id="SquaredStar" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: none; stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M36,43.43l8.18,5.85c.39.28.91-.1.76-.56l-3.18-9.55,8.09-5.98c.39-.28.18-.9-.3-.89l-10.06.08-3.18-9.55c-.15-.45-.8-.45-.94,0l-3.04,9.59-10.06.08c-.48,0-.67.62-.28.9l8.18,5.85-3.04,9.59c-.14.46.38.83.76.55l8.09-5.98Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
var squared_star_default = IconSquaredStar;
...
var IconSquaredVisible = `<svg id="SquaredVisible" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><rect x="13.5" y="13.5" width="45" height="45" rx="4" ry="4" style="fill: none; stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M49.5,36s-6.04,9-13.5,9-13.5-9-13.5-9c0,0,6.04-9,13.5-9s13.5,9,13.5,9Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><circle cx="36" cy="36" r="4.5" style="stroke-width: 0px;"/></svg>`;
var squared_visible_default = IconSquaredVisible;
...
// lib/talk-heart.ts
var IconTalkHeart = `<svg id="TalkHeart" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><path d="M17.5,13.5h37c2.21,0,4,1.79,4,4v28c0,2.21-1.79,4-4,4h-23s-9,9-9,9v-9s-5,0-5,0c-2.21,0-4-1.79-4-4v-28c0-2.21,1.79-4,4-4Z" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke-width: 0px;"/><path d="M36,40.47c-18.67-9.78-9.34-24.63,0-14.67,9.34-9.97,18.67,4.89,0,14.67Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><path d="M17.5,13.5h37c2.21,0,4,1.79,4,4v28c0,2.21-1.79,4-4,4h-23s-9,9-9,9v-9s-5,0-5,0c-2.21,0-4-1.79-4-4v-28c0-2.21,1.79-4,4-4Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
var talk_heart_default = IconTalkHeart;

// lib/talk-info.ts
var IconTalkInfo = `<svg id="TalkInfo" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><path d="M17.5,13.5h37c2.21,0,4,1.79,4,4v28c0,2.21-1.79,4-4,4h-23s-9,9-9,9v-9s-5,0-5,0c-2.21,0-4-1.79-4-4v-28c0-2.21,1.79-4,4-4Z" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke-width: 0px;"/><path d="M17.5,13.5h37c2.21,0,4,1.79,4,4v28c0,2.21-1.79,4-4,4h-23s-9,9-9,9v-9s-5,0-5,0c-2.21,0-4-1.79-4-4v-28c0-2.21,1.79-4,4-4Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><g><polyline points="36 45 36 31.5 31.5 31.5" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><line x1="36" y1="22.5" x2="36" y2="22.5" style="fill: none;  stroke-linecap: round; stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></g></svg>`;
var talk_info_default = IconTalkInfo;
...
var getIcon = (icon) => {
  switch (icon) {
    ...
    case Icons.SYMBOL_FEMALE:
      return symbol_female_default;
    case Icons.SYMBOL_MALE:
      return symbol_male_default;
    case Icons.SYMBOL_UNISEX:
      return symbol_unisex_default;
    ...
    case Icons.COLOR_RGB:
      return color_rgb_default;
    case Icons.COLOR_SWATCHES:
      return color_swatches_default;
    case Icons.COMPASS2:
      return compass2_default;
    case Icons.COMPASS:
      return compass_default;
    case Icons.CUBE3D:
    ...
    case Icons.ACCESSIBILITY_PERSON_CIRCLED:
      return accessibility_person_circled_default;
    case Icons.ACCESSIBILITY_PERSON:
      return accessibility_person_default;
    case Icons.ADD_FAT:
      return add_fat_default;
    case Icons.ADD_L:
      return add_l_default;
    case Icons.ADD_LINES:
      return add_lines_default;
    case Icons.ADD_M:
    ...
    case Icons.BOX_IN:
      return box_in_default;
    case Icons.BOX_OUT:
      return box_out_default;
    case Icons.BOX:
      return box_default;
    case Icons.BOY:
      return boy_default;
    case Icons.BROKEN_HEART_F:
      return broken_heart_f_default;
    case Icons.BROKEN_HEART_L:
      return broken_heart_l_default;
    ...
    case Icons.BUILDING_SHOP:
      return building_shop_default;
    case Icons.BUTTON_ADD:
      return button_add_default;
    case Icons.BUTTON_BROKEN_HEART2:
      return button_broken_heart2_default;
    case Icons.BUTTON_BROKEN_HEART:
      return button_broken_heart_default;
    case Icons.BUTTON_CHECK2:
      return button_check2_default;
    case Icons.BUTTON_CHECK:
      return button_check_default;
    ...
    case Icons.BUTTON_HEART:
      return button_heart_default;
    case Icons.BUTTON_INFO2:
      return button_info2_default;
    case Icons.BUTTON_INFO:
      return button_info_default;
    case Icons.BUTTON_INVISIBLE2:
      return button_invisible2_default;
    ...
    case Icons.BUTTON_SEARCH:
      return button_search_default;
    case Icons.BUTTON_STAR2:
      return button_star2_default;
    case Icons.BUTTON_STAR:
      return button_star_default;
    case Icons.BUTTON_SUBTRACT:
      return button_subtract_default;
    case Icons.BUTTON_VISIBLE2:
      return button_visible2_default;
    case Icons.BUTTON_VISIBLE:
      return button_visible_default;
    case Icons.BUTTON:
    ...
    case Icons.CIRCLE_INVISIBLE:
      return circle_invisible_default;
    ...
    case Icons.CIRCLED_BROKEN_HEART:
      return circled_broken_heart_default;
    ...
    case Icons.CIRCLED_STAR:
      return circled_star_default;
    case Icons.CIRCLED_VISIBLE:
      return circled_visible_default;
    case Icons.CIRCLED:
    ...
    case Icons.CODE_BRACKETS_CIRCLED:
      return code_brackets_circled_default;
    case Icons.CODE_BRACKETS:
      return code_brackets_default;
    case Icons.CODE_CHEVRONS_CIRCLED:
      return code_chevrons_circled_default;
    case Icons.CODE_CHEVRONS_OPEN_CIRCLED:
      return code_chevrons_open_circled_default;
    case Icons.CODE_CHEVRONS_OPEN:
      return code_chevrons_open_default;
    case Icons.CODE_CHEVRONS:
      return code_chevrons_default;
    case Icons.DISLIKE:
      return dislike_default;
    case Icons.EDIT_FAT:
    ...
    case Icons.FILE_HEART2:
      return file_heart2_default;
    case Icons.FILE_HEART:
      return file_heart_default;
    case Icons.FILE_INFO2:
      return file_info2_default;
    case Icons.FILE_INFO:
      return file_info_default;
    case Icons.FILE_INVISIBLE2:
      return file_invisible2_default;
    ...
    case Icons.FILE_SEARCH:
      return file_search_default;
    case Icons.FILE_STAR2:
      return file_star2_default;
    case Icons.FILE_STAR:
      return file_star_default;
    ...
    case Icons.FILE_TEXT:
      return file_text_default;
    case Icons.FILE_VISIBLE2:
      return file_visible2_default;
    case Icons.FILE_VISIBLE:
      return file_visible_default;
    case Icons.FILE:
      return file_default;
    ...
    case Icons.FOLDER_BROKEN_HEART2:
      return folder_broken_heart2_default;
    case Icons.FOLDER_BROKEN_HEART:
      return folder_broken_heart_default;
    ...
    case Icons.FOLDER_HEART:
      return folder_heart_default;
    case Icons.FOLDER_INFO2:
      return folder_info2_default;
    case Icons.FOLDER_INFO:
      return folder_info_default;
    case Icons.FOLDER_INVISIBLE2:
      return folder_invisible2_default;
    case Icons.FOLDER_INVISIBLE:
      return folder_invisible_default;
    ...
    case Icons.FOLDER_SEARCH:
      return folder_search_default;
    case Icons.FOLDER_STAR2:
      return folder_star2_default;
    case Icons.FOLDER_STAR:
      return folder_star_default;
    ...
    case Icons.FOLDER_VISIBLE2:
      return folder_visible2_default;
    case Icons.FOLDER_VISIBLE:
      return folder_visible_default;
    case Icons.FOLDER:
    ...
    case Icons.GIT_COMPARE:
      return git_compare_default;
    case Icons.GIT_MERGE_QUEUE:
      return git_merge_queue_default;
    case Icons.GIT_MERGE:
      return git_merge_default;
    case Icons.GIT_PULL_REQUEST_CLOSED:
      return git_pull_request_closed_default;
    case Icons.GIT_PULL_REQUEST_DRAFT:
      return git_pull_request_draft_default;
    case Icons.GIT_PULL_REQUEST:
      return git_pull_request_default;
    case Icons.GIT_REPO_FORK:
      return git_repo_fork_default;
    case Icons.HEART_BROKEN_SMALL:
      return heart_broken_small_default;
    case Icons.HEART_FAT:
      return heart_fat_default;
    case Icons.HEART_L:
      return heart_l_default;
    case Icons.HEART_M:
      return heart_m_default;
    ...
    case Icons.INVISIBLE_L:
      return invisible_l_default;
    case Icons.INVISIBLE_M:
      return invisible_m_default;
    case Icons.INVISIBLE_S:
      return invisible_s_default;
    case Icons.LIKE:
      return like_default;
    case Icons.LINK:
      return link_default;
    case Icons.MALE_SIMPLIFIED:
      return male_simplified_default;
    case Icons.MOON:
      return moon_default;
    ...
    case Icons.NOTE_ADD2:
      return note_add2_default;
    case Icons.NOTE_ADD:
      return note_add_default;
    case Icons.NOTE_BROKEN_HEART2:
      return note_broken_heart2_default;
    case Icons.NOTE_BROKEN_HEART:
      return note_broken_heart_default;
    ...
    case Icons.NOTE_HEART:
      return note_heart_default;
    case Icons.NOTE_INFO2:
      return note_info2_default;
    case Icons.NOTE_INFO:
      return note_info_default;
    case Icons.NOTE_INVISIBLE2:
      return note_invisible2_default;
    case Icons.NOTE_INVISIBLE:
      return note_invisible_default;
    ...
    case Icons.NOTE_SEARCH:
      return note_search_default;
    case Icons.NOTE_STAR2:
      return note_star2_default;
    case Icons.NOTE_STAR:
      return note_star_default;
    ...
    case Icons.NOTE_VISIBLE2:
      return note_visible2_default;
    case Icons.NOTE_VISIBLE:
      return note_visible_default;
    case Icons.NOTE:
      return note_default;
    case Icons.ON_TARGET:
      return on_target_default;
    case Icons.PARAGRAPH:
      return paragraph_default;
    case Icons.PLAYBACK_BACKWARD:
      return playback_backward_default;
    case Icons.PLAYBACK_END:
      return playback_end_default;
    case Icons.PLAYBACK_FORWARD:
      return playback_forward_default;
    case Icons.PLAYBACK_NEXT:
      return playback_next_default;
    case Icons.PLAYBACK_PAUSE:
      return playback_pause_default;
    case Icons.PLAYBACK_PLAY:
      return playback_play_default;
    case Icons.PLAYBACK_PREVIOUS:
      return playback_previous_default;
    ...
    case Icons.QUESTION_MARK_S:
      return question_mark_s_default;
    case Icons.REMOVE_LINES:
      return remove_lines_default;
    case Icons.SEARCH_FAT:
      return search_fat_default;
    case Icons.SEARCH_L:
      return search_l_default;
    case Icons.SEARCH_M:
      return search_m_default;
    case Icons.SEARCH_SMALL:
      return search_small_default;
    case Icons.SETTINGS2:
      return settings2_default;
    case Icons.SETTINGS3:
      return settings3_default;
    case Icons.SETTINGS4:
      return settings4_default;
    case Icons.SETTINGS:
    ...
    case Icons.SPEECH_BALLOON_SQUARE_COPY:
      return speech_balloon_square_copy_default;
    ...
    case Icons.SQUARED_BROKEN_HEART:
      return squared_broken_heart_default;
    ...
    case Icons.SQUARED_STAR:
      return squared_star_default;
    case Icons.SQUARED_SUBTRACT:
      return squared_subtract_default;
    case Icons.SQUARED_VISIBLE:
      return squared_visible_default;
    case Icons.SQUARED:
      return squared_default;
    case Icons.STAR_FAT:
      return star_fat_default;
    case Icons.STAR_L:
      return star_l_default;
    case Icons.STAR_M:
      return star_m_default;
    case Icons.STAR_SMALL:
      return star_small_default;
    ...
    case Icons.TALK_ADD:
      return talk_add_default;
    case Icons.TALK_CHECK:
      return talk_check_default;
    ...
    case Icons.TALK_STAR:
      return talk_star_default;
    case Icons.TALK_SUBTRACT:
      return talk_subtract_default;
    case Icons.TALK_VISIBLE:
      return talk_visible_default;
    case Icons.TALK:
      return talk_default;
    case Icons.TARGET:
    ...
    case Icons.TEXT_DETAIL_LIST:
      return text_detail_list_default;
    ...
    case Icons.TEXT_ORDER_ASC123:
      return text_order_asc123_default;
    case Icons.TEXT_ORDER_ASC127:
      return text_order_asc127_default;
    case Icons.TEXT_ORDER_DESC_COPY2:
      return text_order_desc_copy2_default;
    case Icons.TEXT_ORDER_DESC_COPY3:
      return text_order_desc_copy3_default;
    case Icons.TEXT_ORDER_DESC_COPY:
      return text_order_desc_copy_default;
    ...
    case Icons.USER_DELETE:
      return user_delete_default;
    case Icons.USER_GROUP:
      return user_group_default;
    case Icons.USER:
      return user_default;
    case Icons.USERS:
      return users_default;
    case Icons.VISIBLE_FAT:
      return visible_fat_default;
    case Icons.VISIBLE_L:
      return visible_l_default;
    case Icons.VISIBLE_M:
      return visible_m_default;
    case Icons.VISIBLE_S:
      return visible_s_default;
    case Icons.VOLUME_I:
      return volume_i_default;
    case Icons.VOLUME_II:
      return volume_ii_default;
    case Icons.VOLUME_III:
      return volume_iii_default;
    case Icons.VOLUME_MUTE:
      return volume_mute_default;
    case Icons.VOLUME_OFF:
      return volume_off_default;
    case Icons.WHEELCHAIR_ACTION:
      return wheelchair_action_default;
    case Icons.WHEELCHAIR:
      return wheelchair_default;
    case Icons.ICON27:
