...
var Icons = {
  ...
  YEN: "yen",
  ICON177: "icon177",
  ACCESSILBITY_PERSON_CICLED: "accessilbity-person-cicled",
  ACCESSILBITY_PERSON: "accessilbity-person",
  ADD_FAT: "add-fat",
  ADD_L: "add-l",
  ADD_M: "add-m",
  ADD_S: "add-s",
...
// lib/search-circled.ts
var IconSearchCircled = `<svg id="SearchCircled" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><circle cx="36" cy="36" r="27" style="fill: none; stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><circle cx="36" cy="36" r="27" style="fill: none; stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><g><path d="M36,9c-14.91,0-27,12.09-27,27s12.09,27,27,27,27-12.09,27-27-12.09-27-27-27ZM33.75,47.25c-7.46,0-13.5-6.04-13.5-13.5s6.04-13.5,13.5-13.5,13.5,6.04,13.5,13.5-6.04,13.5-13.5,13.5Z" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke-width: 0px;"/><line x1="51.75" y1="51.75" x2="43.3" y2="43.3" style="fill: white;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><circle cx="33.75" cy="33.75" r="13.5" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></g></svg>`;
var search_circled_default = IconSearchCircled;

// lib/search.ts
var IconSearch = `<svg id="Search" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><line x1="58.5" y1="58.5" x2="44.23" y2="44.23" style="fill: white; stroke: var(--icon-stroke-color-secondary, var(--icon-stroke-color, currentColor)); stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/><circle cx="31.5" cy="31.5" r="18" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke-width: 0px;"/><circle cx="31.5" cy="31.5" r="18" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
...
var IconSpeechBalloon = `<svg id="SpeechBalloon" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><path d="M9,31.5c0-14.91,12.09-21.6,27-21.6s27,6.69,27,21.6-12.09,21.6-27,21.6c-1.63,0-3.22-.08-4.77-.25l-9.74,9.74c-.86.86-2.34.25-2.34-.97v-12.32c-6.18-3.43-10.15-9.27-10.15-17.81Z" style="fill: var(--icon-fill, rgba(0, 0, 0, 0)); opacity: var(--icon-fill-opacity, 1); stroke-width: 0px;"/><path d="M9,31.5c0-14.91,12.09-21.6,27-21.6s27,6.69,27,21.6-12.09,21.6-27,21.6c-1.63,0-3.22-.08-4.77-.25l-9.74,9.74c-.86.86-2.34.25-2.34-.97v-12.32c-6.18-3.43-10.15-9.27-10.15-17.81Z" style="fill: none;  stroke-miterlimit: 10; stroke-width:var(--icon-stroke-width-m, calc(var(--icon-stroke-width, 5) * 1));"/></svg>`;
...
var getIcon = (icon) => {
  switch (icon) {
    ...
    case Icons.ACCESSILBITY_PERSON_CICLED:
      return accessilbity_person_cicled_default;
    case Icons.ACCESSILBITY_PERSON:
      return accessilbity_person_default;
    case Icons.ADD_FAT:
    ...
    case Icons.CODE_CHEVRONS_COPY:
      return code_chevrons_copy_default;
    case Icons.CODE_CHEVRONS_CIRCLED_COPY:
      return code_chevrons_circled_copy_default;
...
export {
  accessilbity_person_default as AccessilbityPerson,
  accessilbity_person_cicled_default as AccessilbityPersonCicled,
  ...
  board01_default as Board01,
  board77_default as Board77,
  board_add_default as BoardAdd,
  board_add2_default as BoardAdd2,
  board_check_default as BoardCheck,
  board_check2_default as BoardCheck2,
  board_edit_default as BoardEdit,
  board_edit2_default as BoardEdit2,
  ...
  board_multiply_default as BoardMultiply,
  ...
  code_chevrons_circled_copy_default as CodeChevronsCircledCopy,
  code_chevrons_copy_default as CodeChevronsCopy,
  ...
  heart_broken_default as HeartBroken,
  highlight_default as Highlight,
  icon177_default as Icon177,
  ...
  note_copy2_default as NoteCopy2,
  ...
  search_circled_default as SearchCircled,
  ...
  speech_balloon3_default as SpeechBalloon3,
  ...
  text_order_asc_default as TextOrderAsc,
